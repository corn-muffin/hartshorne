...
\begin{proof}
  (II, 5.8) gives us that $f_*\F$ is quasi-coherent, since $X$ is noetherian.
...
\begin{proof}
  ...
  We compute
  \begin{align*}
    C^\bullet &= \left[0\to \frac{k[\frac{x_0}{x_1},\frac{x_2}{x_1}]}{(f(\frac{x_0}{x_1},1,\frac{x_2}{x_1}))}\oplus \frac{k[\frac{x_0}{x_2},\frac{x_1}{x_2}]}{(f(\frac{x_0}{x_2},\frac{x_1}{x_2},1))}\xrightarrow{d} \frac{k[y_1,y_2^{\pm1}]}{f} \right]
  \end{align*}
\end{proof}
